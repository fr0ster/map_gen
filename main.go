...
var headerTmpl string = `// Code generated by \"map_gen %[1]s\"; DO NOT EDIT"

package %[2]s
`

var funcEqMapTmpl string = `
func %[1]sEq(amap %[1]s, bmap %[1]s) bool {
        if len(amap) == len(bmap) {
                for akey, aval := range amap {
                        if bval, ok := bmap[akey]; !(ok && aval == bval) {
                                return false
                        }
                }
                return true
...
func (g *Generator) generate(typeName string) {
	...
	*/
	...
	//fmt.Fprintf(&g.buf, constMapTmpl, typeName, strings.Join(consts, ", "))
	fmt.Fprintf(&g.buf, funcEqMapTmpl, typeName)
}
